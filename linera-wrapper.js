...
export async function getClientAndChain(faucetUrl, privateKeyHex, blackjackAppId) {
    ...
    try {
        ...
        // Get Blackjack Application
        const blackjack = await chain.application(blackjackAppId);
        console.log('JS | Blackjack App Ready');
